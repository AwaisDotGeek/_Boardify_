<template>
    <section :id="id" class="border-2 border-black-2 shadow-lg shadow-black-5 flex gap-4 rounded-xl p-5 max-w-6xl">
        <div class="w-1/2 overflow-hidden rounded-xl">
            <img :src="getImgSrc" alt="" class="w-full h-full object-cover transition-all brightness-75 hover:brightness-100 hover:scale-110">
        </div>
